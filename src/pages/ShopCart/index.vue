  ...
  <div class="cart">
    ...
    <div class="cart-tool">
      <div class="select-all">
        ...
        <input class="chooseAll" type="checkbox" v-model="isChecks" @change="updateAllChecked" />
        <span>全选</span>
      </div>
      <div class="option">
      ...
      <div class="money-box">
        <div class="chosed">
          已选择 <span>{{ filterArr.length }}</span
          >件商品
        </div>
        <div class="sumprice">
          <em>总价（不含运费） ：</em>
...
export default {
  ...
  computed: {
    ...
    // 选中状态的数组
    filterArr() {
      return this.shopList.filter(item => item.isChecked == 1)
    },
    //计算总价
    totalPrice() {
      //累加操作
